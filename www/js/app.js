...
.constant('db', {
  db: 'http://root:BestInternship33@127.0.0.1:5984/bucket-list'
})
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('tab.fulfilled', {
    ...
    views: {
      'tab-fulfilled': {
        templateUrl: 'templates/tab-fulfilled.html',
  ...
  .state('tab.to-fulfill', {
      ...
      views: {
        'tab-to-fulfill': {
          templateUrl: 'templates/tab-to-fulfill.html',
          controller: 'ToFulfillCtrl'
        }
      }
    })
    .state('tab.to-fulfill-detail', {
      url: '/to-fulfill/:bucketListItemId',
      views: {
        'tab-to-fulfill': {
  ...
  $urlRouterProvider.otherwise('/tab/to-fulfill');
